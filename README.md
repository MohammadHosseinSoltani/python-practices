...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/MohammadHosseinSoltani/python-practices.git
   cd python-practices
   ```
...
- 🐛 **Found a bug?** [Open an issue](https://github.com/MohammadHosseinSoltani/python-practices/issues)
